...
NOTE: Now that project construction has started, this document is not up-to-date
however, it is still useful for seeing the general idea behind the design.
...
*** Parse Set Error Method
    ...
    - UNEXPECED_EOF :: Unexpected end of file.
...
**** Description
     DEPRECATED: the lexer fills this purpose now.
...
**** Description
     DEPRECATED: the lexer handles this now.
...
*** Byte Code Specification
   ...
   - STK_POP :: Pops the top most item off of the nesting stack.
